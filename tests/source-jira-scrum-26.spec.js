...
const { SourceJiraScrum26RequirementPage } = require('../pages/SourceJiraScrum26RequirementPage.js');

test('Source: Jira SCRUM-26
...
TC-DATA-01 Audit log entry created for each failed login', async ({ page }) => {
    const pageObject = new SourceJiraScrum26RequirementPage(page);
    await pageObject.goto();
    await pageObject.fillUsername("sana");
